...
class PTBModel(object):
  ...
  def __init__(self, is_training, config, input_, global_step):
    self._input = input_
    ...
    lstm_cell = tf.contrib.rnn.LSTMBlockCell(
    ...
    with tf.name_scope("Test"):
      ...
      with tf.variable_scope("Model", reuse=True, initializer=initializer):
        mtest = PTBModel(is_training=False, config=eval_config,
                         input_=test_input, global_step=global_step)

    with tf.train.MonitoredTrainingSession(
        checkpoint_dir=FLAGS.save_path) as sess:
...
#        sv.saver.save(sess, FLAGS.save_path, global_step=sv.global_step)
  ...
  print ("========================================")
  print ("Time elapsed is {0:5.3f} sec.".format(time.time() - start_time))
  print ("========================================")
